    ...
    <Link href={`/expertise/${slug}`} className='flex w-[309px] flex-col'>
      ...
      <div className='flex h-full w-full flex-1 flex-col items-stretch rounded-b-[5px] bg-white p-[25px]'>
        <NextLinePreposition
          tag='h3'
          text={title}
          className='line-clamp-3 overflow-hidden font-unbound text-[12px] font-bold uppercase leading-[1] text-text-dark'
        />
        <NextLinePreposition
          tag='p'
          text={description}
          className='mt-[19px] line-clamp-3 overflow-hidden font-proxima text-[16px] leading-[1.25] text-text-dark'
        />
      </div>
    </Link>
  );
