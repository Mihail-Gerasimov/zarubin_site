      ...
      <ul className={styles.list}>
          ...
          <ul className={styles.subList}>
            ...
            <li className={styles.item}>
              <p className='description'>
                ...
                for distribution - personal data to which an unlimited number of
                ...
                - personal data authorized for distribution).
              </p>
            </li>
            <li className={styles.item}>
              <p className='description'>
            ...
            <li className={styles.item}>
              <p className='description'>
                ...
                information and telecommunications networks or providing access
            ...
            <li className={styles.item}>
              <p className='description'>
                ...
                which personal data is permanently destroyed with the
          ...
          <ul className={styles.subList}>
            <li className={styles.item}>
              ...
              <p className={styles.description}>
                ...
                otherwise provided by the Law on Personal Data or other federal
                laws.
              </p>
            </li>
            <li className={styles.item}>
              ...
              <p className={styles.description}>
                – to provide the subject of personal data, at his request, with
                information concerning the processing of his personal data;
              </p>
              <p className={styles.description}>
              ...
              <p className={styles.description}>
                – to inform the authorized body for the protection of the rights
                of personal data subjects at the request of this body of the
        ...
        <li className={styles.item}>
          ...
          <ul className={styles.subList}>
            <li className={styles.item}>
              ...
              <p className={styles.deletion}>
                – receive information concerning the processing of his personal
                data, except in cases provided for by federal laws. The
                information is provided to the personal data subject by the
                Operator in an accessible form, and it should not contain
                personal data related to other personal data subjects, except in
                cases where there are legitimate grounds for disclosure of such
                personal data. The list of information and the procedure for
                obtaining it is established by the Law on Personal Data;
              </p>
              <p className={styles.deletion}>
              ...
              <p className={styles.deletion}>
                ...
                of personal data subjects or in court against illegal actions or
        ...
        <li className={styles.item}>
          ...
          <ul className={styles.subList}>
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                5.4. Also on site is the collection and processing of anonymous
                data about visitors (including cookies) using Internet
                statistics (Yandex Metric and Google Analytics and others).
              </p>
            </li>
            <li className={styles.item}>
              <p className={styles.deletion}>
                5.5. The above data, hereinafter referred to in the text of the
                Policy, are combined by the general concept of Personal Data.
              </p>
            </li>
            <li className={styles.item}>
              <p className={styles.deletion}>
                5.6. Processing of special categories of personal data relating
                to race, nationality, political views, religious or
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                5.7. Processing of personal data permitted for distribution from
                among the special categories of personal data specified in Part
                1 of Article 10 of the Law on Personal Data is allowed if the
                prohibitions and conditions provided for in Article 10.1 of the
                Law on Personal Data are observed.
              </p>
            </li>
            <li className={styles.item}>
              <p className={styles.deletion}>
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                5.8.3 The transfer (distribution, provision, access) of personal
                data authorized by the personal data subject for distribution
                must be terminated at any time at the request of the personal
                data subject. This requirement must include the surname, first
                name, patronymic (if any), contact information (phone number,
                email address or postal address) of the personal data subject,
                as well as a list of personal data whose processing is subject
                to termination. The personal data specified in this request can
                only be processed by the Operator to whom it is sent.
              </p>
            </li>
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                Operator receives the request specified in clause 5.8.3 of this
                Policy regarding the processing of personal data.
              </p>
            </li>
          </ul>
        ...
        <li className={styles.item}>
          ...
          <ul className={styles.subList}>
            <li className={styles.item}>
              <p className={styles.deletion}>
                6.1. Personal data processing is carried out on a legal and fair
                basis.
              </p>
            </li>
            <li className={styles.item}>
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                data, the processing of which is carried out for purposes
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                relation to the purposes of personal data processing is ensured.
                The Operator takes the necessary measures and/or ensures that
                they are taken to delete or clarify incomplete or inaccurate
                data.
              </p>
            </li>
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                allows determining the subject of personal data, no longer than
                the purposes of personal data processing require, unless the
                storage period of personal data is established by federal law,
                an agreement to which the subject of personal data is a party,
                beneficiary or guarantor. The processed personal data is
                destroyed or depersonalized upon achievement of the processing
                goals or in case of loss of the need to achieve these goals,
        ...
        <li className={styles.item}>
          ...
          <ul className={styles.subList}>
            <li className={styles.item}>
              ...
              <ul>
                <li>
                  – contracts concluded between the operator and the subject of
                  personal data;
                </li>
                <li>
                  – federal laws and other regulatory legal acts in the field of
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                <Link className={styles.link} href='https://www.zarubin.co.uk'>
                  https://www.zarubin.co.uk
                </Link>{' '}
                {`or
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                provision of his personal data and gives consent freely, of his
                own free will and in his own interest.
              </p>
            </li>
          </ul>
        </li>
        <li className={styles.item}>
          ...
          <ul className={styles.subList}>
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                9.2. The processing of personal data is necessary to achieve the
                goals stipulated by an international agreement of the Russian
                Federation or a law, to carry out the functions, powers and
                duties assigned to the operator by the legislation of the
                Russian Federation.
              </p>
            </li>
            <li className={styles.item}>
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                execution of a contract to which the personal data subject is a
                party or beneficiary or guarantor, as well as for the conclusion
                of a contract on the initiative of the personal data subject or
                a contract under which the personal data subject will be a
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                the rights and freedoms of the personal data subject are not
                violated.
              </p>
            </li>
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                unlimited number of persons to which is provided by the subject
                of personal data or at his request (hereinafter referred to as
          ...
          <ul className={styles.subList}>
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                ensured through the implementation of legal, organizational and
                technical measures necessary to fully comply with the
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                all possible measures to exclude access to the personal data of
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                Policy. The subject of personal data and/or the User is obliged
                to familiarize themselves with these documents in a timely
                manner. The Operator is not responsible for the actions of third
                parties, including the service providers specified in this
                paragraph.
              </p>
            </li>
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                data on the transfer (except for granting access), as well as on
                the processing or processing conditions (except for obtaining
                access) of personal data permitted for distribution, do not
                apply in cases of processing of personal data in the state,
                public and other public interests defined by the legislation of
                the Russian Federation.
              </p>
            </li>
            <li className={styles.item}>
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                purposes of personal data processing require, unless the period
                of personal data storage is established by federal law, an
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                subject, as well as the identification of unlawful processing of
                personal data.
              </p>
            </li>
          </ul>
          ...
          <ul className={styles.subList}>
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                data, the Operator is obliged to make sure that the foreign
                state to whose territory the transfer of personal data is
                supposed to be carried out provides reliable protection of the
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                foreign states that do not meet the above requirements may be
                carried out only if there is written consent of the personal
                data subject to cross-border transfer of his personal data
                and/or execution of the contract to which the personal data
                subject is a party.
              </p>
            </li>
          </ul>
            ...
            <li className={styles.item}>
              <p className={styles.deletion}>
                ...
                <Link
                  ...
                  href='https://www.zarubin.co.uk/policy'
                >
                  https://www.zarubin.co.uk/policy
                </Link>
                .
              </p>
            </li>
