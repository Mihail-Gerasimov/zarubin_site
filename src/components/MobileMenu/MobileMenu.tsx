              ...
              <li key={item.id} className='flex flex-col'>
                <div className='flex items-center gap-[10px]'>
                  ...
                  {item.name.toLowerCase() === 'expertise' && (
                    ...
                    >
                      <Arrow
                        className={`h-[auto] w-[25px]  transition-transform duration-300 ease-in-out hover:fill-main-blue ${dark ? 'fill-white' : 'fill-main-bg'} ${isOpenSubMenu ? '-rotate-90' : 'rotate-90'}`}
                      />
                    </button>
                  )}
                </div>
