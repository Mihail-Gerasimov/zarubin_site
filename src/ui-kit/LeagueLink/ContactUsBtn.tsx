...
export const ContactUsBtn = ({ dark }: { dark: boolean }) => {
  return (
    <Link
      ...
      className={twMerge(
        classNames(
          'font-proxima-reg hidden h-[46px] min-w-[162px] items-center justify-center rounded-[4px] font-proxima text-[20px] font-bold transition tablet:rounded-[8px] desktop:flex desktop:rounded-[6px]',
          dark
