...
export default function Home() {
  ...
  return (
    <>
      <main className='mt-[100px] pt-[30px] w-full'>
        <div className='backImage w-full tablet:py-[31px] desktop:py-[48px] flex flex-col items-center gap-[20px]'>
          <h1 className='text-[45px] leading-[1] uppercase z-[5] tablet:text-[60px] desktop:text-[90px]'>
            Insights
          </h1>
          <p className='text-[20px] text-[#00030C] leading-[1.2] z-[5] text-center'>
